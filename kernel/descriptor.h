...
/*
 * 80386 interrupt/trap gate descriptor. This structure is based on MINIX 3.1.0's
 */
...
/*
 * Descriptor-table pointer used by LGDT and LIDT. The 80386 expects: 16-bit limit 32-bit base address
 */
